...
# Script to create the appointment_bookings table with ESM module support

echo "=================================="
echo "Creating appointment_bookings table"
echo "=================================="

# Run the Node.js script with .mjs extension to force ESM mode
cat > ./scripts/create-appointment-bookings.mjs << 'EOL'
...
# Run the MJS file
node ./scripts/create-appointment-bookings.mjs

...
- **Mezők**:
  ...
  - `hurdle_step` (0-3, **beszámított** pont: a gyengébb oldal)
  - `inline_lunge` (0-3, **beszámított** pont: a gyengébb oldal)
  - `shoulder_mobility` (0-3, **beszámított** pont: a gyengébb oldal, `sm_clearing` esetén 0)
  - `active_straight_leg_raise` (0-3, **beszámított** pont: a gyengébb oldal)
  - `trunk_stability_pushup` (0-3, `tspu_clearing` esetén 0)
  - `rotary_stability` (0-3, **beszámított** pont: a gyengébb oldal, `rs_clearing` esetén 0)
  - `<teszt>_left` / `<teszt>_right` (nyers oldalankénti pont az 5 páros teszthez; a 2026-08-01 előtti felméréseknél NULL)
  - `sm_clearing`, `tspu_clearing`, `rs_clearing` (boolean fájdalomtesztek; true → a hozzájuk tartozó pontszám 0)
  - `total_score` (generált mező a 7 beszámított pontszám összegével)
